...
if [[ $mode = 'train' ]];then
    ...
    CUDA_VISIBLE_DEVICES=$1 python tasks/run_video_qa.py --task msvd_qa --config ./configs/msvd_qa_base3.json --ans2label_path ../dataset/msvd_qa/annotations/train_ans2label.json 
else
